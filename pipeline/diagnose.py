...
raw=yf.download(['^NSEI','NIFTYMIDCAP150.NS','RELIANCE.NS','TCS.NS','DISHTV.NS'],period='7y',auto_adjust=False,group_by='ticker',progress=False,threads=4,timeout=20)
for t in ['^NSEI','NIFTYMIDCAP150.NS','RELIANCE.NS','TCS.NS','DISHTV.NS']:
    frame=raw[t]
