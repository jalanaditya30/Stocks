...
async function boot(data=snapshot,chartDate=data.asof,research=null){
 ...
 w.fetch=async url=>({ok:true,json:async()=>url.includes('backtest')?research:url.includes('latest')?data:url.includes('health')?{status:'ok'}:{asof:chartDate,charts:{[base.isin]:chart,INE000000002:{...chart,c:[101,113]},INE000000003:{...chart,c:[99,100]}}}});
